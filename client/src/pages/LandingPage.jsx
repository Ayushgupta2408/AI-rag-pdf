      ...
      <section id="demo" className="max-w-6xl mx-auto px-6 mb-12">
        <div className="relative rounded-[32px] overflow-hidden bg-slate-100 border-8 border-slate-50 shadow-2xl shadow-indigo-100">
          <div className="aspect-video w-full bg-slate-200 flex items-center justify-center relative group">
            <iframe className='w-full h-full' src="https://www.youtube.com/embed/5rS45rgS0CE" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; compute-pressure" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center space-x-4">
            <Link to={'https://github.com/Ayushgupta2408/NeuraDocs'}>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              ...
              <div className="flex items-center p-6 rounded-3xl bg-slate-50 border border-slate-100 hover:border-indigo-200 transition-all group">
                <div className="text-left">
                  <h4 className="font-bold text-slate-900 group-hover:text-indigo-600 transition-colors">Ayush kumar Gupta</h4>
                  <div className="flex gap-3 mt-2 justify-center items-center">
                    <a href="https://ayushgupta08.netlify.app" className="text-slate-400 hover:text-slate-900 transition-colors">Portfolio</a>
                    <a href="https://github.com/Ayushgupta2408" className="text-slate-400 hover:text-slate-900 transition-colors"><Github className="h-7 w-7" /></a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="py-12 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a href="https://github.com/Ayushgupta2408/NeuraDocs" className="text-slate-400 hover:text-indigo-600 text-xs font-bold uppercase tracking-tighter transition-colors">Github</a>
            <a href="https://github.com/Ayushgupta2408/NeuraDocs" className="text-slate-400 hover:text-indigo-600 text-xs font-bold uppercase tracking-tighter transition-colors">Documentation</a>
          </div>
        </div>
      </footer>
    </div>
